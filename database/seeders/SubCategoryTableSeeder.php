...
class SubCategoryTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('sub_categories')->insert([
            ...
            [
                'id' => 11,
                'name' => 'AUTOMATION & ROBOTICS EXPERT',
                'category_id' => 1  
            ],
            [
                'id' => 12,
            ...
            [
                'id' => 23,
                'name' => 'VENTURE CAPITALIST EXPERT',
                'category_id' => 1  
            ],
            [
                'id' => 24,
            ...
            [
                'id' => 32,
                'name' => 'HEALTH CARE STARTUP OF THE YEAR',
                'category_id' => 2 
            ],
            [
                'id' => 33,
                'name' => 'LEGAL TECH STARTUP OF THE YEAR',
                'category_id' => 2 
            ],
            [
                'id' => 34,
                'name' => 'EDUTECH STARTUP OF THE YEAR',
                'category_id' => 2 
            ],
            [
                'id' => 35,
                'name' => 'INSURTECH STARTUP OF THE YEAR',
                'category_id' => 2 
            ],
            [
                'id' => 36,
                'name' => 'AI TECH STARTUP OF THE YEAR',
                'category_id' => 2 
            ],
            [
                'id' => 37,
                'name' => 'PROPTECH STARTUP OF THE YEAR',
                'category_id' => 2 
            ],
            [
                'id' => 38,
                'name' => 'AGRITECH STARTUP OF THE YEAR',
                'category_id' => 2 
            ],
            [
                'id' => 39,
                'name' => 'E-COMMERCE STARTUP OF THE YEAR',
                'category_id' => 2 
            ],
            [
                'id' => 40,
                'name' => 'ENERGY TECH STARTUP OF THE YEAR',
                'category_id' => 2 
            ],
            [
                'id' => 41,
                'name' => 'FINTECH STARTUP OF THE YEAR',
                'category_id' => 2 
            ],
            [
                'id' => 42,
            ...
            [
                'id' => 43,
                'name' => 'MARKETING COMPANY OF THE YEAR',
                'category_id' => 2 
            ],
            [
                'id' => 44,
                'name' => 'ENTERPRISE COMPANY OF THE YEAR',
                'category_id' => 2 
            ],
            [
                'id' => 45,
